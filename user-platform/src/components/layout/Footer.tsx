        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="/careers" className="text-gray-500 hover:text-gray-900 transition-colors">
              ...
              <li>
                <Link href="/press" className="text-gray-500 hover:text-gray-900 transition-colors">
                  Prensa
                </Link>
              </li>
            </ul>
